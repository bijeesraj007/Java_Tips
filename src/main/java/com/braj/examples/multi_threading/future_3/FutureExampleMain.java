...
public class FutureExampleMain {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            Future<String> randomFutureString = threadPool.submit(new RandomStringGenerator());
            Future<Integer> randomFutureNumber = threadPool.submit(new RandomNumberGenerator());
            ...
            // Note that though 5 sec + 3 sec is the execution time for each method , the elasped time is only 5 sec (NOT 8 Sec).
